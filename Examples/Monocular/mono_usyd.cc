...
int main(int argc, char **argv)
{
    ...
    distanceCoeffs.at<double>(0, 0) = -0.05400957120448697;
    distanceCoeffs.at<double>(1, 0) = -0.07842753582468161;
    distanceCoeffs.at<double>(2, 0) = 0.09596410068935728;
    distanceCoeffs.at<double>(3, 0) = -0.05152529532743679;
    ...
    for (int v = 3; v < argc; v++)
    {
        // if (v == 4){
        //     SLAM.ActivateLocalizationMode();
        // }
        // Step 1: Open the video file
        string strPathToVideo = string(argv[v]);
        ...
        for (int ni = 0; ni < 28000; ni++)
        {
            ...
            {
                cerr << endl
                     << "Failed to load image at: " << ni << endl;
                return 1;
            }
            cv::Mat im;
